...
describe("AaveMarketV2AdapterMatic Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        const strategy = "0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf"; // LendingPool
        ...
        // Deploy AaveMarketV2AdapterMatic Adapter contract
        const AaveMarketV2AdapterMatic = await adapterFixtureMatic(
            "AaveMarketV2AdapterMatic"
        );
        this.adapter = await AaveMarketV2AdapterMatic.deploy(
            strategy,
            usdc,
            aUSDC,
            swapRouter,
        ...
        console.log("AaveMarketV2AdapterMatic: ", this.adapter.address);
    });
