...
describe("AlpacaAutoVaultAdapter Integration Test", function () {
  before("Deploy contract", async function () {
    ...
    const strategy = "0xe9Bd0B7333596d0a87DED9EE1a782AA052B711AB"; // Market Neutral 3x BNB-USDT PCS1
    ...
    // Deploy Alpada AutoVault Adapter contract
    const AlpacaAdapter = await ethers.getContractFactory("AlpacaAutoVaultAdapter");
    ...
    console.log("AlpacaAutoVaultAdapter: ", this.aAdapter.address);
