...
describe("AlpacaFarmAdapter Integration Test", function () {
  before("Deploy contract", async function () {
    const [owner, alice, bob, tom] = await ethers.getSigners();

    const performanceFee = 50;
    const wbnb = "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c";
    const strategy = "0xfF693450dDa65df7DD6F45B4472655A986b147Eb"; // ibCake Vault
    const stakingToken = "0x804678fa97d91B974ec2af3c843270886528a9E6" // Cake-BUSD PKS LP
    const repayToken = "0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F"; // ALPACA
    ...
    // Deploy Alpada Farm Adapter contract
    const AlpacaAdapter = await ethers.getContractFactory("AlpacaFarmAdapter");
    ...
    await this.aAdapter.setPath(wbnb, cakeAddr, [wbnb, cakeAddr]);
    await this.aAdapter.setPath(cakeAddr, wbnb, [cakeAddr, wbnb]);
    await this.aAdapter.setPath(wbnb, BUSDAddr, [wbnb, BUSDAddr]);
    await this.aAdapter.setPath(BUSDAddr, wbnb, [BUSDAddr, wbnb]);
    ...
    console.log("AlpacaFarmAdapter: ", this.aAdapter.address);
  ...
  describe("depositBNB function test", function() {
    ...
    it("(4) deposit should success for Alice", async function () {
        ...
        // expect(BigNumber.from(repayBal).gt(0)).to.eq(true);
    }).timeout(50000000);
