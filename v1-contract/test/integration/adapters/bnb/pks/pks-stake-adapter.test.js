...
describe("Pancakeswap Stake Adapter Integration Test", function () {
  before("Deploy contract", async function () {
    ...
    // Mint NFTs
    // tokenID: 1
    await this.ybNft.mint([10000], [cake], [this.pksStakeAdapter.address], performanceFee, "test tokenURI1");

    // tokenID: 2
    await this.ybNft.mint([10000], [cake], [this.pksStakeAdapter.address], performanceFee, "test tokenURI2");
