...
describe("Pancakeswap Stake Adapter Integration Test", function () {
  ...
  describe("depositBNB function test", function () {
    ...
    it("(3)deposit should success for Alice", async function () {
      ...
      const aliceWithdrable = await this.pksStakeAdapter.getWithdrawalAmount(
        this.aliceAddr,
        1
      );
    ...
    it("(4)deposit should success for Bob", async function () {
      ...
      const bobWithdrable = await this.pksStakeAdapter.getWithdrawalAmount(
        this.bobAddr,
        1
      );
    ...
    it("(5)deposit should success for Tom", async function () {
      ...
      const tomWithdrable = await this.pksStakeAdapter.getWithdrawalAmount(
        this.tomAddr,
        1
      );
