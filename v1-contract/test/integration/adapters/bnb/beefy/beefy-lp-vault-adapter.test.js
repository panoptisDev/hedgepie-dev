...
describe("BeefyLPVaultAdapter Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        const beefyAdapter = await ethers.getContractFactory(
            "BeefyVaultAdapter"
        );
    ...
    describe("depositBNB function test", function () {
        ...
        it("(3) deposit should success for Alice", async function () {
            ...
            expect(BigNumber.from(aliceInfo)).to.eq(
        ...
        it("(4) deposit should success for Bob", async function () {
            ...
            expect(BigNumber.from(bobInfo)).to.eq(
                BigNumber.from(depositAmount)
            );
        ...
        it("(5) deposit should success for tom", async function () {
            ...
            expect(BigNumber.from(tomInfo)).to.eq(
                BigNumber.from(depositAmount)
            );
