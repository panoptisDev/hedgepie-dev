...
describe("ApeswapPoolAdapter Integration Test", function () {
  ...
  describe("withdrawBNB() function test", function () {
    ...
    it("(2)should receive BNB successfully after withdrawBNB function", async function () {
    ...
    it("(3)should receive BNB successfully after withdrawBNB function for bob", async function () {
      // withdraw from nftId: 1
    ...
    it("(4)should receive BNB successfully after withdrawBNB function for tom", async function () {
      // withdraw from nftId: 1
