...
describe("AlpacaAdapter Unit Test", function () {
  before("Deploy contract", async function () {
    ...
    this.strategy = "0xd7D069493685A581d27824Fc46EdA46B7EfC0063";
    this.stakingToken = "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c" // WBNB
    this.repayToken = "0x6A3487CE84FD83c66B83e598b18412bD1D2A55F9";
  ...
  describe("should get invest call data", function () {
    it("should get invest call data properly", async function () {
      const result = await this.aAdapter.getInvestCallData(ethers.utils.parseUnits("343"));
      console.log(result, "getInvestCallData");
  ...
  describe("should get devest call data", function () {
    it("should get devest call data properly", async function () {
      const result = await this.aAdapter.getDevestCallData(ethers.utils.parseUnits("343"));
      console.log(result, "getDevestCallData");
      expect(!!result).to.eq(true);
    });
  });
