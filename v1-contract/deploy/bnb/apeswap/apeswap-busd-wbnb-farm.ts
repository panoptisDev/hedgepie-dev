...
const apeswapFarmLpAdapterArgs =
  apeswapFarmLpAdapterArgsList["ApeSwap::Farm::BUSD-WBNB"];
...
async function deploy() {
  ...
  console.log("111--->2");
  // set path
  await await apeswapLpAdaper.setPath(WBNB, BUSD, [WBNB, BUSD], {
    gasPrice: 12e9,
  });
  console.log("111--->3");
  await await apeswapLpAdaper.setPath(BUSD, WBNB, [BUSD, WBNB], {
    gasPrice: 12e9,
  });
  console.log("111--->4");
