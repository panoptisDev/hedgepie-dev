...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
  ...
  // NOTE (appleseed): loading bsc mainnet as default rpc provider for a non-connected wallet
  const jsonRpcProvider = new StaticJsonRpcProvider(NETWORKS[56].uri())
  const [provider, setProvider] = useState<JsonRpcProvider>(jsonRpcProvider)
