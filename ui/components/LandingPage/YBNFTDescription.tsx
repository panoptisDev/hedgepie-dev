  ...
  return (
    <Box p={3} css={{ border: "1px solid black", paddingTop: "4rem", paddingBottom: "6rem" }}>
      ...
      >
        ...
        >
          <Flex
            css={{ alignItems: "center", justifyContent: "center", padding: "40px", gap: "30px" }}
          >
            <Flex css={{ flexDirection: "column", gap: "10px" }}>
              ...
              >
                ...
                <Text css={{ color: "#8E8DA0", fontSize: "16px" }}>
            ...
            <Flex css={{ width: "40rem", flexDirection: "column" }}>
              <Flex css={{ flexDirection: "column" }}>
                <Flex>
                  <Flex css={{ flexDirection: "column" }}>
                    <Text css={{ color: "#DF4886", fontSize: "20px", fontWeight: "500" }}>
                      Series Name
                    </Text>
                  ...
                  >
                    <Text css={{ fontSize: "20px", fontWeight: "700", color: "#ABABAB" }}>
                      OWNER
                    </Text>
              ...
              >
                ...
                <Flex css={{ gap: "15px", flexWrap: "wrap" }}>
                  ...
                  >
                    ...
                    <Flex css={{ flexDirection: "column" }}>
                      <Text css={{ fontWeight: "700", fontSize: "22px", color: "#0A3F5C" }}>
                        1.9
                      </Text>
                      <Text css={{ color: "#8E8DA0", fontSize: "14px", fontWeight: "500" }}>
                        (1,213.95 USD)
                      </Text>
                    </Flex>
                  </Flex>
