...
export { default as PenguinsIcon } from "./Icons/Penguins";
export { default as PenguinRoundIcon } from "./Icons/PenguinRound";
...
export { default as NestIcon } from "./Icons/Nest";
export { default as IglooIcon } from "./Icons/Igloo";
export { default as CrownIcon } from "./Icons/Crown";
export { default as BattleIcon } from "./Icons/Battle";
export { default as XPefiLogoIcon } from "./Icons/XPefiLogo";
export { default as AvaxLogoIcon } from "./Icons/AvaxLogo";
export { default as IPefiLogoIcon } from "./Icons/IPefiLogo";
export { default as IPefiLogoIconTop } from "./Icons/IPefiLogoTop";
export { default as WalletIcon } from "./Icons/Wallet";
export { default as DarkLogoIcon } from "./Icons/DarkLogo";
export { default as LightLogoIcon } from "./Icons/LightLogo";
