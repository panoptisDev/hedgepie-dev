    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'row', gap: '50px', alignItems: 'center' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', gap: '20px', alignItems: 'center' }}>
          ...
          <Box sx={{ backgroundColor: '#F3F3F3', color: '#000000', padding: '0.5rem', borderRadius: '8px' }}>90D</Box>
          <Box sx={{ backgroundColor: '#F3F3F3', color: '#000000', padding: '0.5rem', borderRadius: '8px' }}>1M</Box>
        </Box>
      </Box>
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: '20px', padding: '1rem' }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
          ...
          <Text sx={{ fontWeight: '400', fontSize: '16px', fontFamily: 'Inter', color: '#666666' }}>Current APY</Text>
        </Box>
