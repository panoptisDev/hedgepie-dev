        ...
        <>
          <Box sx={{ display: 'flex', flexDirection: 'row', gap: '50px', alignItems: 'center' }}>
            <Box sx={{ display: 'flex', flexDirection: 'row', gap: '0px', alignItems: 'center' }}>
              ...
              >
                <Text sx={{ fontSize: '16px', fontFamily: 'Plus Jakarta Sans', fontWeight: '600' }}>APY</Text>
              </Box>
              <Box
                sx={{
              ...
              >
                <Text sx={{ fontSize: '16px', fontFamily: 'Plus Jakarta Sans', fontWeight: '600' }}>TVL</Text>
              </Box>
              <Box
                sx={{
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: '20px', padding: '1rem' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
              <Text sx={{ fontWeight: '600', fontSize: '26px', fontFamily: 'Plus Jakarta Sans' }}>5%</Text>
              <Text sx={{ fontWeight: '400', fontSize: '16px', fontFamily: 'Plus Jakarta Sans', color: '#666666' }}>
                Current APY
              </Text>
            </Box>
