export const styles = {
  ...
  badge_title_text: { color: '#0B4C6F',lineHeight:'14px', fontFamily:'Plus Jakarta Sans', fontSize:'16px' },
  badge_value_text: { color: '#0B4C6F',lineHeight:'14px', fontFamily:'Plus Jakarta Sans',fontSize:'16px' },
  ...
  nft_name_text: { color: '#14114B', fontWeight: '360', fontSize: '32px', fontFamily:'Plus Jakarta Sans', lineHeight:'32px' },
  ...
  strategy_detail_apy_text: { color: '#8988A5', fontFamily: 'Plus Jakarta Sans', fontWeight: '600', fontSize: '16px' },
  ...
  owner_image: { width: ['60px','60px','120px'], height: ['60px','60px','120px'], borderRadius:'300px', marginRight:'10px' },
  flex_staking_details: { alignItems: 'center', justifyContent: 'center', gap: '1rem', flexDirection: 'column',padding:['0rem','0rem','0 0rem 0 1rem'] },
  staking_sub_title_text: { fontFamily: 'Plus Jakarta Sans', fontSize: '20px', fontWeight: '600', color: '#FD5298' },
  unstake_button: {
  ...
  details_title_text: { fontSize: '16px', fontWeight: '600', fontFamily: 'Plus Jakarta Sans', color: '#8E8DA0' },
